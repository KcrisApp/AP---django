...
class Order(TimeStampedModel):
    ...
    order_file_topographic = models.FileField(upload_to='topographic', default="", blank=True)
    order_file_gerber = models.FileField(upload_to='gerber', default="", blank=True)
    order_file_odb = models.FileField(upload_to='odb', default="", blank=True)
    order_file_schematics = models.FileField(upload_to='schematics', default="", blank=True)
