<template>
  <main>
    <div class="p-4 w-full">
      ...
      <div class="flex my-4">
        <span
          class="bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Numero
          utenti: {{ usersCount }}</span>
      </div>
      <table v-if="onLoad" class="text-left text-sm font-light flex-wrap w-full">
        ...
        <tbody>
          <tr class="border-b dark:border-neutral-500" v-for="user in paginatedData">
            ...
            <td class="whitespace-nowrap py-4">
              <router-link :to="{
                ...
                <font-awesome-icon icon="fa-eye" class="text-blue-950 hover:text-green-500" />
              </router-link>
            </td>
          </tr>
        </tbody>
