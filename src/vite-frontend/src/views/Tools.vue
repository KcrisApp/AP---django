      ...
      <div class="grid gap-4 grid-cols-1 xl:grid-cols-4">
        <div
          ...
          <button @click="togleModalScan"
            class="block w-full rounded bg-green-600 px-12 py-3 text-sm font-medium text-white shadow hover:bg-green-800 focus:outline-none focus:ring sm:w-auto">QRcode
            Scan</button>
        </div>
        <div
          class="max-w-sm p-6 bg-slate-100 border border-gray-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
