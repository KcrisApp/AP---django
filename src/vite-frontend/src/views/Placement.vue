...
// Conteggio codici
// const codeCount = computed(()=>{
//   return order.order_placement_pick_and_place.value.length
// })
...
<div class="flex gap-2">
        <span
          ...
          >Posizioni totali: {{ codeCount }}</span
        >
        ...
        <span
          ...
          >Posizioni verificate: {{ codeCheckedItem }}</span
        >
      </div>
        ...
        <tbody>
         ...
         <!-- :class = "id == 2 ?'border-red-500 border-solid border-4':''" -->
            ...
            class=" border-b dark:border-gray-700">
                ...
                scope="row" 
                class="px-6 py-4 font-medium  whitespace-nowrap dark:text-white0">{{ row.type }}
              </th>
            </td>
            <td 
            class=" border-b dark:border-gray-700">
              ...
              <th 
                ...
                scope="row" 
                class="px-6 py-4 font-medium  whitespace-nowrap dark:text-white0">{{ row.component }}
              </th>
            </td>
              <td 
            class=" border-b dark:border-gray-700">
              ...
              <th 
                ...
                scope="row" 
                class="px-6 py-4 font-medium  whitespace-nowrap dark:text-white0">{{ row.desc }}
              </th>
            </td>
              <td 

              @click="addNoteToItem(idx)"
            class=" border-b dark:border-gray-700">
