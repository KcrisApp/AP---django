<template>
  <main>
    <BoardForm v-show="showForm" @close-modal="togleModal" @save-data="updateBoardsList" />
    <div class="p-4 w-full">
          ...
          <form class="">
            <div class="relative">
              ...
              <input type="search" id="default-search"
                ...
                placeholder="Cerca per nome scheda" v-model="search" />
            </div>
          </form>
        </div>
      ...
      <table class="text-left text-sm font-light flex-wrap w-full">
        ...
        <tbody>
          <tr class="border-b dark:border-neutral-500" v-for="board in paginatedData" :key="board.uuid">
