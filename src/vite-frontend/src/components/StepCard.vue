<template>
  <li>
    <div class="ml-2">
      <span
        class="bg-gray-100 text-gray-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 border border-gray-500"><font-awesome-icon
          icon="diagram-project" /> Fase {{ index + 1 }}</span>
    </div>
    <div class="p-2 max-w-sm">
      <div class="border border-slate-100 flex rounded-lg h-full bg-slate-50 dark:bg-gray-800 flex-col">
        <div class="py-2 rounded-md bg-blue-950 text-white">
        ...
        <div class="p-2">
          ...
          <div v-if="store.permissionAccess" class="p-2" @mouseenter="togleActionBtn" @mouseleave="togleActionBtn">
          ...
          <div class="flex flex-col justify-between flex-grow mt-4">
            <span :style="{ 'background-color': step.step_color }"
              class="text-black text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">
              {{ step.step_type }}</span>
          </div>
        </div>
      </div>
