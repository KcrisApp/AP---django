    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
      <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        <div
          ...
          <div class="bg-white px-2 pb-2 pt-2 sm:p-6 sm:pb-4">
            <div class="">
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                ...
                <div class="flex justify-between my-2">
                  ...
                  <h2 class="text-base font-semibold leading-6 p-2 text-gray-900" id="modal-title">
                    <b class="text-blue-900">Aggiungi / Modifica nota</b>
                  </h2>
                ...
                <div class="mt-4">
                  <div class="mb-6">
                    ...
                    <textarea :value="modelValue" @input="$emit('update:modelValue', $event.target.value)"
                      ...
                      name="note" id="note" cols="30" rows="3" ref="textareaRef"></textarea>
                  </div>
