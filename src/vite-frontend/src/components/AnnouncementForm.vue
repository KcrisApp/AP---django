            ...
            <div class="">
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                ...
                <div class="mt-4">
                  ...
                  <div class="mb-6">
                    <label for="status" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipo di
                      annuncio:</label>
                    <select v-model="type" id="status"
                  ...
                  <div class="mb-6 mt-4">
                    ...
                    <input type="titleForm" id="orderNumber"
                  ...
                  <div class="mb-6 mt-4">
                    <label for="content"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Testo</label>
                    <textarea type="text" id="content"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder="" required v-model="text_content" />
                  </div>
