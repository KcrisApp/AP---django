              ...
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                ...
                <div class="mt-2">
                  <form class="w-full max-w-lg" @submit.prevent="sentData">
                    <div class="flex flex-wrap -mx-3 mb-6">
                      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                          ...
                          type="text" placeholder="" id="customer" name="customer" v-model="customer" />
                      ...
                      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                          class="appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                          type="text" name="board_name" id="board_name" v-model="board_name" />
                        <!-- <p class="text-red-500 text-xs italic">
                          Please fill out this field.
                        </p> -->
                      </div>
                      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                          class="appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                          type="text" id="board_code" name="board_code" v-model="board_code" />
                      ...
                      <div class="w-full md:w-1/2 px-3">
                        ...
                        <input
                          ...
                          type="text" id="board_rev" name="board_rev" v-model="board_rev" />
                      </div>
                    ...
                    <div class="mb-6">
                      <label for="alert"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alert</label>
                      <textarea v-model="board_alert"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        name="alert" id="alert" cols="30" rows="3"></textarea>
