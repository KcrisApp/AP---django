<template>
   ...
   <button @click="showSidebar" aria-controls="default-sidebar" type="button"
      class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg xl:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
   ...
   <aside id="default-sidebar" :class="sideBarHide ? '-translate-x-full' : ''"
         ...
         <ul class="space-y-2 font-medium">
            ...
            <div class="flex justify-between">
               ...
               <li v-show="!sideBarHide" @click.prevent="hideSidebar">
                  <a
                     class="flex items-center xl:hidden p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <div class="pb-4">
               <RouterLink to="my-info" class="text-sm ml-2">
                  <span class="py-2">Benvenuto {{ store.userData.first_name }}</span>
               </RouterLink>
            ...
            <li>
               ...
               <ul :class="dropdownShow ? 'hidden' : ''" id="dropdown-example" class=" py-2 space-y-2">
                  <li @click="hideSidebar">
                     <a
                  ...
                  <li @click="dropdownShow = !dropdownShow">
                     <a v-if="store.permissionAccess" href="/accounts/register/"
            ...
            <li>
               <a href="/accounts/logout/"
                  class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-white hover:text-red-700 dark:hover:bg-gray-700 group">
