                ...
                <ul
                  ...
                  <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div class="flex items-center ps-3">
                      <input id="ict" type="checkbox" v-model="ict"
                      ...
                      <label for="ict"
                        class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ict</label>
                    </div>
                  </li>
                  <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div class="flex items-center ps-3">
                      <input id="aoi" type="checkbox" v-model="aoi"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                      <label for="aoi"
                        class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">AOI</label>
                    </div>
                  </li>
                  <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div class="flex items-center ps-3">
                      <input id="xray" name="xray" type="checkbox" v-model="xray"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                      <label for="xray"
                        class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">X-ray</label>
                    </div>
                  </li>
                  <li class="w-full dark:border-gray-600">
                    <div class="flex items-center ps-3">
                      <input id="functional" type="checkbox" v-model="functional"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                      <label for="functional"
                        class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">FT</label>
                    </div>
                  </li>
                </ul>
                <hr class="my-5">
                <div class="mt-4">
                  <div class="mb-6">
                    <label for="serialnumber"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Serial number testati</label>
                    <input type="text" id="serialnumber"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      required v-model="serialnumber" />
                  </div>
                  <div class="mb-6">
                  ...
                  <div class="mb-6">
                    <label for="non_compliance" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Non
                      conformita</label>
                    <textarea v-model="non_compliance"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      name="non_compliance" id="non_compliance" cols="30" rows="3"></textarea>
                  </div>
                  <hr>
                  <div class="mb-6 mt-4">
