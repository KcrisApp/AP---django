          ...
          <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            <div class="">
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                ...
                <div class="mt-4">
                  <div class="mb-6">
                    <label for="changes_after_testing"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Modifica dopo
                      collaudo</label>
                    <textarea v-model="changes_after_testing"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      name="changes_after_testing" id="changes_after_testing" cols="30" rows="3"></textarea>
                  </div>
                  <div class="mb-6">
                  ...
                  <div class="mb-6">
                    <label for="manual_work"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lavorazioni manuali</label>
                    <textarea v-model="manual_work"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      name="manual_work" id="manual_work" cols="30" rows="3"></textarea>
                  </div>
                  <hr>
                  <div class="mb-6 mt-4">
